...
public class PlayNote : MonoBehaviour
{
    ...
    //A long list of all the notes frequency(hz). Used to play a wide variety of tones. Musical Note infomation https://www.liutaiomottola.com/formulae/freqtab.htm
